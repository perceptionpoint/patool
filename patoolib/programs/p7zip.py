...
def extract_7z(
    ...
    if password:
        ...
        cmdlist.append('-p-')
    cmdlist.extend([f'-o{outdir}', '-aou', '--', archive])
    return cmdlist
...
extract_zip = extract_rar = extract_cab = extract_chm = extract_arj = extract_cpio = (
    extract_rpm
) = extract_deb = extract_iso = extract_udf = extract_vhd = extract_7z
...
list_bzip2 = list_gzip = list_zip = list_compress = list_rar = list_cab = list_chm = (
    list_arj
) = list_cpio = list_rpm = list_deb = list_iso = list_udf = list_xz = list_lzma = list_vhd = (
    list_7z
)
...
test_bzip2 = test_gzip = test_zip = test_compress = test_rar = test_cab = test_chm = (
    test_arj
) = test_cpio = test_rpm = test_deb = test_iso = test_udf = test_xz = test_lzma = test_vhd = (
    test_7z
)
